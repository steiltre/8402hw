  ...
  \item \begin{problem}
      ...
      \begin{enumerate}
        ...
        \item Show that the $O(\varepsilon)$ equation is
          ...
          - f \left( y_0, \frac{\partial y_0}{\partial t_1} \right) \]

        \item In order to avoid secular terms, show that the conditions to be
          satisfied are:
          \[ \frac{\partial A}{\partial t_2} = \frac{1}{2 \pi} \int_{0}^{2 \pi} f \left( y_0, \frac{\partial y_0}{\partial t_1} \right) \sin \tau d \tau \]
          and
          \[ A \frac{\partial \phi}{\partial t_2} = \frac{1}{2 \pi} \int_{0}^{2 \pi} f \left( y_0, \frac{\partial y_0}{\partial t_1} \right) \cos \tau d \tau .\]
