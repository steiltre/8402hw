    ...
    \begin{solution}
      ...
      \begin{enumerate}
          \item
            ...
            \[ \int_{-1}^{1} u_0 (u_{1,yy} + \lambda_n^2 u_1) dy = i \int_{-1}^{1} u_0 (\theta_{xx} u_0 + 2 \theta_x u_{0,x} + \omega \alpha u_0) dy \]
            ...
            So we have
            \begin{align*}
              0 &= \int_{-1}^{1} u_0 (\theta_{xx} u_0 + 2 \theta_x u_{0,x} + \omega \alpha u_0) dy \\
